...
--><li class="tile tile-small">
        <?php if ($image_data): ?>
            <a href="<?php the_permalink()?>" class="tile-pan" style="background-image: url(<?php echo $image_data[0]; ?>);" aria-labelledby="meta project_tagline" role="img"><img src="<?php echo $image_data[0]; ?>" alt="<?php the_title(); ?>" /></a>
        <?php else: ?>
