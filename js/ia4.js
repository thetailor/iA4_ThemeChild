...
var iA4 = (function($) {
    ...
    var methods = {
        ...
        toggleSearch: function(e) {
            ...
            var viewport = $(window.document).width() > 767 ? 'desktop' : 'mobile';
        ...
        adjustPlaceholder: function(ev) {
            $(window.document).width() > 767 ? $('#search-term').attr('placeholder', 'What are you looking for?') : $('#search-term').attr('placeholder', 'Search');
        },
